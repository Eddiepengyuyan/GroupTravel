...
<head>
	...
	<script>
		function countDown(){
			...
			if(time.innerHTML == 0){
				//等于0时清除计时，并跳转该指定页面
				window.location.href="/GroupAct?teamId=${requestScope.teamId}";
			}else{
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-xs-center">
    ...
    <p class="tm-subtitle">页面将在<span id="Time" >5</span>秒后自动跳转，若没有，请点击<a href="/GroupAct?teamId=${requestScope.teamId}">这里</a></p>
</div>
